...
export function FinanceMenuCard({ item }: FinanceMenuCardProps) {
  ...
  return (
    <button
      type="button"
      disabled
      className="group flex min-h-[156px] flex-col justify-between rounded-[18px] border border-[#E8D7BE] bg-[#FFFDF8] p-5 text-right shadow-[0_14px_30px_rgba(86,52,31,0.12),inset_0_1px_0_rgba(255,255,255,0.85)] transition duration-200 hover:-translate-y-1 hover:border-[#C99A4D] hover:shadow-[0_20px_45px_rgba(86,52,31,0.18),inset_0_1px_0_rgba(255,255,255,0.9)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#B88334] focus-visible:ring-offset-2 focus-visible:ring-offset-[#F7EFE4]"
    >
